 ...
 */
VOICE_API void datachannel_connection_config_init(datachannel_connection_config_t *config);

/**
 * @brief Create DataChannel connection
 */
VOICE_API datachannel_connection_t *datachannel_connection_create(
    const datachannel_connection_config_t *config);

/**
 * @brief Destroy connection
 */
VOICE_API void datachannel_connection_destroy(datachannel_connection_t *conn);

/**
 * @brief Connect to remote peer
 */
VOICE_API voice_error_t datachannel_connection_connect(datachannel_connection_t *conn);

/**
 * @brief Close connection
 */
VOICE_API voice_error_t datachannel_connection_close(datachannel_connection_t *conn);
 ...
 */
VOICE_API voice_error_t datachannel_connection_process(datachannel_connection_t *conn,
                                              int timeout_ms);

/**
 * @brief Check if connection is established
 */
VOICE_API bool datachannel_connection_is_connected(datachannel_connection_t *conn);

/**
 * @brief Get local port (useful if port was auto-assigned)
 */
VOICE_API uint16_t datachannel_connection_get_local_port(datachannel_connection_t *conn);
 ...
 */
VOICE_API void datachannel_config_init(datachannel_config_t *config);

/**
 * @brief Create a new DataChannel
 */
VOICE_API datachannel_t *datachannel_create(datachannel_connection_t *conn,
                                   const datachannel_config_t *config);

/**
 * @brief Close a DataChannel
 */
VOICE_API voice_error_t datachannel_close(datachannel_t *channel);

/**
 * @brief Send binary data
 */
VOICE_API voice_error_t datachannel_send(datachannel_t *channel,
                                const void *data,
                                size_t size);
 ...
 */
VOICE_API voice_error_t datachannel_send_text(datachannel_t *channel,
                                     const char *text);

/**
 * @brief Get channel state
 */
VOICE_API datachannel_state_t datachannel_get_state(datachannel_t *channel);

/**
 * @brief Get channel ID
 */
VOICE_API uint16_t datachannel_get_id(datachannel_t *channel);

/**
 * @brief Get channel label
 */
VOICE_API const char *datachannel_get_label(datachannel_t *channel);

/**
 * @brief Get channel protocol
 */
VOICE_API const char *datachannel_get_protocol(datachannel_t *channel);

/**
 * @brief Get buffered amount (bytes waiting to send)
 */
VOICE_API uint32_t datachannel_get_buffered_amount(datachannel_t *channel);

/**
 * @brief Set buffered amount low threshold
 */
VOICE_API void datachannel_set_buffered_amount_low_threshold(datachannel_t *channel,
                                                    uint32_t threshold);

/**
 * @brief Get channel statistics
 */
VOICE_API voice_error_t datachannel_get_stats(datachannel_t *channel,
 ...
 */
VOICE_API void datachannel_set_on_open(datachannel_t *channel,
 ...
 */
VOICE_API void datachannel_set_on_close(datachannel_t *channel,
 ...
 */
VOICE_API void datachannel_set_on_error(datachannel_t *channel,
 ...
 */
VOICE_API void datachannel_set_on_message(datachannel_t *channel,
 ...
 */
VOICE_API void datachannel_set_on_buffered_low(datachannel_t *channel,
 ...
 */
VOICE_API const char *datachannel_state_to_string(datachannel_state_t state);

/**
 * @brief Get type as string
 */
VOICE_API const char *datachannel_type_to_string(datachannel_type_t type);
 ...
 */
VOICE_API datachannel_t *datachannel_create_reliable(datachannel_connection_t *conn,
                                            const char *label);

/**
 * @brief Create simple unreliable channel
 */
VOICE_API datachannel_t *datachannel_create_unreliable(datachannel_connection_t *conn,
                                              const char *label);

/**
 * @brief Create channel with max retransmits
 */
VOICE_API datachannel_t *datachannel_create_with_retransmits(datachannel_connection_t *conn,
                                                    const char *label,
                                                    int max_retransmits);
 ...
 */
VOICE_API datachannel_t *datachannel_create_with_lifetime(datachannel_connection_t *conn,
                                                 const char *label,
                                                 int max_lifetime_ms);
