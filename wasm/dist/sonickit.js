...
function findWasmBinary() {
  return locateFile('sonickit.wasm');
}
...
var ASM_CONSTS = {
  7716: ($0, $1) => { var level = UTF8ToString($0); var msg = UTF8ToString($1); if (level === "ERROR") { console.error("[SonicKit]", msg); } else if (level === "WARN") { console.warn("[SonicKit]", msg); } else if (level === "DEBUG") { console.debug("[SonicKit]", msg); } else { console.log("[SonicKit]", msg); } }
};
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createSonicKit;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createSonicKit;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createSonicKit);
